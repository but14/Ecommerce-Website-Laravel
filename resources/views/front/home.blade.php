			...
			<div class="col-lg-6 col-6 text-left  d-flex justify-content-end align-items-center">
				...
				<form action="">					
					<div class="input-group">
						<input type="text" placeholder="Bạn cần tìm gì..." class="form-control" aria-label="Amount (to the nearest dollar)">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="footer-card">
					<h3>Liên lạc</h3>
					<p>Chọn phong cách, Chọn WolfShop <br>
					104, Nguyễn Văn Trỗi, Quận Phú Nhuận, TP Hồ Chí Minh  <br>
